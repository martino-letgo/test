var customCommands = require('../tsrc/utils/customCommands');
var CustomReporter = require('../tsrc/utils/reporter').SimpleReporter;
...
exports.config = {
    ...
    //baseUrl: 'https://us.beta.dev.letgo.com/en/',
    baseUrl: 'https://us.letgo.com/en/',
    ...
    // reporters: ['spec'],
  reporters: ['dot','cucumber','allure','junit'],
    reporterOptions: {
         allure: {
            outputDir: './report/allure-results'
        },
        junit: {
            outputDir: './report/junit-results'
        }
    },
    //
    ...
    cucumberOpts: {
        ...
        require: ['src/steps/home.ts','src/steps/login.ts', 'src/steps/search.ts','src/steps/browser.ts'], // <string[]> (file/dir) require files before executing features
        ...
        format: ['summary'], // <string[]> (type[:path]) specify the output
