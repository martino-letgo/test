...
exports.config = {
    ...
    cucumberOpts: {
        ...
        require: ['src/steps/home.ts','src/steps/login.ts', 'src/steps/search.ts'], // <string[]> (file/dir) require files before executing features
 // <string[]> (file/dir) require files before executing features
    ...
    onComplete: function onComplete(exitCode) {
        ...
        var generation = allure(['generate', './report/allure-results', './report/allure-results-html' ]);
